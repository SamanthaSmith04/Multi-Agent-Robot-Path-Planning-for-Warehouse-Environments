function [done] = visualizeRRTmotion3(simulated_robots,timeStep,map,grid_size,figureNumber)
...
robot = simulated_robots(i).robot;
...
for j=1:num_bots
    robotCurrentPose = simulated_robots(j).pose(end,:);

...
outputStructFileName = "Experiment_Results/RRT_exp1map1-2.xml";
...
for num_robots=1: size(robot_positions,1)
    ...
    robot.road = RRT(robot.start, robot.goal, map_array, grid_size, false, fig_num);
...
disp("ready")
[phi, time, robots] = motionPlan_RRT_multiple(robots, map, map_array, grid_size, false, 5, fig_num);
